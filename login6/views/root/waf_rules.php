...
<head>
    ...
    <title>Reglas WAF - <?php echo APP_NAME; ?></title>
    ...
    <style>
        ...
        .icon-large { font-size: 4rem; color: #ec4899; margin-bottom: 20px; }
...
<body>
    <div class="placeholder-container">
        ...
        <h1>Reglas WAF</h1>
        <p>Crear y gestionar reglas de firewall de aplicaciones web. <strong>Funcionalidad #4</strong></p>
